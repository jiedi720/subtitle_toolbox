...
def apply_theme_enhanced(mode):
    ...
    if fixed_labels > 0:
        print(f"  - 修复了 {fixed_labels} 个硬编码颜色的标签")
    
    print(f"[OK] 主题已切换到: {mode}")
...
if __name__ == "__main__":
    ...
    print("增强的主题切换脚本")
    print("使用方法:")
    print("  from gui.theme_switch import apply_theme_enhanced")
    print("  apply_theme_enhanced('Light')")
    print("  apply_theme_enhanced('Dark')")
    print("  apply_theme_enhanced('System')")